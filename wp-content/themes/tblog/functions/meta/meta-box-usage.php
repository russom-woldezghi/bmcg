...
$tblog_meta_boxes = array();

// meta box ===> Slides
$tblog_meta_boxes[] = array(
	'id' => 'slides_meta',
	'title' => __('Slide Options','tblog'),
	'pages' => array('slides'),

	'fields' => array(
			array(
            'name' => __('Slide Description','tblog'),
            'desc' => __('Enter a description for your slider (optiona). Use h2 tag for a nice title.','tblog'),
            'id' => $prefix . 'slides_description',
            'type' => 'textarea',
            'std' => ''
        ),
		array(
            'name' => __('Slide URL','tblog'),
            'desc' => __('Enter a URL to link this slide to - perfect for linking slides to pages on your site or other sites. Optional.','tblog'),
...
// DO NOT DELETE BELOW
foreach ($tblog_meta_boxes as $meta_box) {
	new tblog_meta_box($meta_box);
}
?>