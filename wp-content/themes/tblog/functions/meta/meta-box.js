jQuery(document).ready(function($) {
	...
	// colorpicker field
	$('.tblog-color-picker').each(function(){
		var $this = $(this),
			id = $this.attr('rel');

		$this.farbtastic('#' + id);
	});
	$('.tblog-color-select').click(function(){
		$parent = $(this).parent();
		$(this).siblings('.tblog-color-picker').toggle();
		$('.tblog-color-select', $parent).toggle();
		return false;
	});

	// add more file
	$('.tblog-add-file').click(function(){
	...
	// delete file
	$('.tblog-upload').delegate('.tblog-delete-file', 'click' , function(){
		var $this = $(this),
			$parent = $this.parent(),
			data = $this.attr('rel');
	...
	$('.tblog-images').each(function(){
		...
		$this.sortable({
			...
			update: function (){
				...
				data = order + '|' + $this.siblings('.tblog-images-data').val();
	...
	// thickbox upload
	$('.tblog-upload-button').click(function(){
	...
	// thickbox upload
    window.formfield = '';
    $('.tblog-upload-single-image').live('click', function() {
        window.formfield = $('.tblog-single-image',$(this).parent());
