...
class tblog_flickr extends WP_Widget {
	
	function tblog_flickr() {
		...
		// register the widget
		$this->WP_Widget('tblog_flickr', __('Flickr'), $widget_ops);
...
add_action('widgets_init', create_function('', 'return register_widget("tblog_flickr");'));	
?>